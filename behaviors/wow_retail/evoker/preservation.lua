...
local function Dispel()
  ...
  if naturalize:Dispel(true, DispelPriority.Low, types.Magic, types.Poison) then return true end
  if cauterize:Dispel(true, DispelPriority.Low, types.Bleed, types.Curse, types.Disease) then return true end
end
